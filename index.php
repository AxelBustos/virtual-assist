...
<body>
    ...
    <header class="head"> 
     ...
     <div class="contenido">
         <p class="texto">Te invitan este Webinar, donde trataremos la tematica de como humanizar la experiencia del cliente de Banca y Seguros en el nuevo entorno digital.<br><br> Además podremos conocer las estrategias que aplicó LOREM para generar una experiencia memorable para sus clientes, mientras se convertía en el gran Unicornio de LATAM. <br><br> Escucha de primera mano la voz de nuestros especialistas: </p>
            <br><br>
            <div class="b"><img src="imagenes/prado.svg"></div>

            <div class="a">
             <img src="imagenes/img-aurnheimer.png" class="fp"><a style="
                                                                font-size: 20px;color: #02363D;line-height: 26px;">
                                                                <p>José Perez<p></a>
                                                                <a style="font-family: SharpSansNo1-Medium;
                                                                font-size: 16px;
                                                                color: #021800;
                                                                line-height: 26px;"><p>Customer Service Senior Manager</p></a>
            </div>
       
            <div class="a">
            <img src="imagenes/img-rodriguez.png" class="fp"><a style="
                                                               font-size: 20px;color: #02363D;line-height: 26px;">
                                                               <p>José Perez<p></a>
                                                               <a style="font-family: SharpSansNo1-Medium;
                                                               font-size: 16px;
                                                               color: #021800;
                                                               line-height: 26px;"><p>Senior Customer Success Consultant</p></a>
            </div>
            <div class="a">
        <img src="imagenes/img-astudillo.png" class="fp"><a style="
                                                           font-size: 20px;color: #02363D;line-height: 26px;">
                                                           <p>José Perez<p></a>
                                                           <a style="font-family: SharpSansNo1-Medium;
                                                           font-size: 16px;
                                                           color: #021800;
                                                           line-height: 26px;"><p>José Perez Gerente de Consultoría de Soluciones</p></a>
            </div>
            <br><br>
        <p class="texto">Participá e inspirate para renovar y mejorar la interacción entre clientes y marcas con historias de éxito de empresas del ambito financiero en América Latina <br><br> ¡Te esperamos! </p>
           <br><br><br><img src="imagenes/Group 5.jpg">
    <!--contenedor donde muestra el texto y los invitados que daran la charla-->
     </div>
    ...
    <div class="des">
        ...
        <form method="POST" id="formulario">
            ...
            <p class="descriplabel" for="apellido">Apellido:
                <input type="text" class="inp" name="apellido" id="apellido">
            </p><br>

            <p class="descriplabel" for="email">Correo electrónico del trabajo: 
            ...
            <p class="descriplabel" for="telefono">Número de teléfono: 
                <input type="number" id="telefono" name="telefono" class="inp" id="telefono">
            </p><br>

            <p class="descriplabel" for="puesto">Puesto de trabajo:
